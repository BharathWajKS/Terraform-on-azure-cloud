...
git clone https://github.com/bharathwaj/terraform-on-azure-with-azure-devops.git
```
...
https://github.com/bharathwaj/terraform-on-azure-with-azure-devops.git
```
...
- For detailed understanding we need to reference this topic from our [Demo-67: Azure HashiCorp Terraform Associate Certification course]
```t
...
- **Name your Azure DevOps organization:** bharathwaj
...
- Go to  Azure DevOps -> Organization (bharathwaj) -> Project (terraform-on-azure-with-azure-devops) -> Pipelines -> Pipelines
- Click on **New Pipeline**
- **Where is your code?:** GitHub
- Follow browser redirect steps to integrate with Github Account
- **Select a repository:** bharathwaj/terraform-on-azure-with-azure-devops
...
- Go to  Azure DevOps -> Organization (bharathwaj) -> Project (terraform-on-azure-with-azure-devops) > Project Settings -> Pipelines -> Service Connections
...
- We have already created that as part of [Section-24-Step-02](https://github.com/bharathwaj/terraform-on-azure-cloud/tree/main/24-Terraform-Remote-State-Storage#step-02-create-azure-storage-account) which will re-use here. 
```t
...
- Go to  Azure DevOps -> Organization (bharathwaj) -> Project (terraform-on-azure-with-azure-devops) -> Pipelines -> Releases
- Click on **New Release Pipeline**
- **Pipeline Name:** Terraform-CD
### Dev Stage
- **Stage Name:** Dev Stage
- **Stage Owner:** bharathwaj.ks@gmail.com (your-azure-admin-id)
...
- Go to  Azure DevOps -> Organization (bharathwaj) -> Project (terraform-on-azure-with-azure-devops) -> Pipelines -> Releases -> Terraform-CD
...
- Go to  Azure DevOps -> Organization (bharathwaj) -> Project (terraform-on-azure-with-azure-devops) -> Pipelines -> Pipelines -> Terraform Continuous Integration CI Pipeline
...
- Go to  Azure DevOps -> Organization (bharathwaj) -> Project (terraform-on-azure-with-azure-devops) -> Pipelines -> Releases -> Terraform CD -> Edit
